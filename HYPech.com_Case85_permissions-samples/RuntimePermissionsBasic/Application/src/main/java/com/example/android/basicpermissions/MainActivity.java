 ...
 * 0. ({@link android.Manifest.permission#CAMERA})
 ...
 * 2. {@link ActivityCompat#requestPermissions(Activity, String[], int)}. The result of the request is
 * returned to the

 * 3. {@link androidx.core.app.ActivityCompat.OnRequestPermissionsResultCallback}, which starts
