...
import com.reapex.sv.adapter.RegionAdapter;
import com.reapex.sv.L0_Constant;
import com.reapex.sv.daodb.RegionDao;
 ...
 * @author zhou
 */
public class PickRegionActivity extends L0_BaseActivity {
...
//sv             mUser.setUserRegion(mRegion);
...
//sv                     mUser.setUserRegion(mRegion);
    ...
    private void modifyRegion() {
        String url = L0_Constant.BASE_URL + "users/" + mUser.getUserId() + "/userRegion";
