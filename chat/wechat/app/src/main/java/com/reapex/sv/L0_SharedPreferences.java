...
public class L0_SharedPreferences {
    private SharedPreferences sharedPreferences = null;
    private SharedPreferences.Editor editor = null;
    private Object object;
    public static L0_SharedPreferences preferencesUtil;

    public static L0_SharedPreferences getInstance() {
        if (preferencesUtil == null) {
            synchronized (L0_SharedPreferences.class) {
                if (preferencesUtil == null) {
                    // 使用双重同步锁
                    preferencesUtil = new L0_SharedPreferences();
                }
            }
        }
