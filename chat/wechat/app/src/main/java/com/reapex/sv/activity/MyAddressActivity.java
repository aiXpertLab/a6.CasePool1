...
import com.reapex.sv.adapter.MyAddressAdapter;
import com.reapex.sv.L0_Constant;
import com.reapex.sv.daodb.AddressDao;
import com.reapex.sv.entitydaodb.Address;
 ...
 * @author zhou
 */
public class MyAddressActivity extends L0_BaseActivity {
    ...
    private void getAddressListByUserId(String userId) {
        String url = L0_Constant.BASE_URL + "users/" + userId + "/address";
    ...
    private void deleteAddress(String userId, final String addressId) {
        String url = L0_Constant.BASE_URL + "users/" + userId + "/address/" + addressId;
