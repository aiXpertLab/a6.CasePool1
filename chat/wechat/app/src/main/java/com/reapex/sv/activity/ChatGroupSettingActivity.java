 ...
 * @author zhou
 */
public class ChatGroupSettingActivity extends L0_BaseActivity implements View.OnClickListener {
    ...
    private void exitGroup(String groupId) {
        ...
        Intent intent = new Intent(this, L4_MainActivity.class);
