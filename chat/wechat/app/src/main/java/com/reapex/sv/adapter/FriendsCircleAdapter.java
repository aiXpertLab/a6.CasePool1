...
import com.reapex.sv.activity.ViewPagerImageActivity;
import com.reapex.sv.L0_Constant;
import com.reapex.sv.entitydaodb.FriendsCircle;
import com.reapex.sv.entitydaodb.FriendsCircleComment;
import com.reapex.sv.entitydaodb.User;
import com.reapex.sv.utils.L_CommonUtil;
import com.reapex.sv.L0_SharedPreferences;
import com.reapex.sv.utils.TextParser;
import com.reapex.sv.utils.TimestampUtil;
import com.reapex.sv.utils.VolleyUtil;
import com.reapex.sv.widget.FriendsCircleCommentListView;
import com.reapex.sv.widget.FriendsCirclePhotoGridView;
...
public class FriendsCircleAdapter extends BaseAdapter {
    ...
    public FriendsCircleAdapter(List<FriendsCircle> friendsCircleList, Context context, ClickListener clickListener) {
        ...
        this.mUser = L0_SharedPreferences.getInstance().getUser();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        viewHolder.mNickNameTv.setText(friendsCircle.getUserName());
        ...
        List<String> photoList = L_CommonUtil.getListFromJson(friendsCircle.getCirclePhotos(), String.class);
        ...
        List<User> likeUserList = L_CommonUtil.getListFromJson(friendsCircle.getLikeUserJsonArray(), User.class);
        ...
        if (likeUserList.size() > 0) {
            ...
            for (final User likeUser : likeUserList) {
                index++;
                textParser.append(likeUser.getUserName(), 20, color, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        List<FriendsCircleComment> commentList =
                L_CommonUtil.getListFromJson(friendsCircle.getFriendsCircleCommentJsonArray(), FriendsCircleComment.class);
    ...
    private void likeFriendsCircle(final FriendsCircle friendsCircle) {
        String url = L0_Constant.BASE_URL + "friendsCircle/" + friendsCircle.getCircleId() + "/like";
    ...
    private void unLikeFriendsCircle(final FriendsCircle friendsCircle) {
        String url = L0_Constant.BASE_URL + "friendsCircle/" + friendsCircle.getCircleId() + "/like?userId=" + mUser.getUserId();
