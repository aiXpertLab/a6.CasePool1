...
import com.reapex.sv.adapter.PeopleNearbyAdapter;
import com.reapex.sv.L0_Constant;
import com.reapex.sv.daodb.ContactsDao;
import com.reapex.sv.entitydaodb.PeopleNearby;
import com.reapex.sv.entitydaodb.PositionInfo;
 ...
 * @author zhou
 */
public class PeopleNearbyActivity extends L0_BaseActivity {
        ...
        mSettingIv.setOnClickListener(view -> {
            ...
            mFemalesOnlyRl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mDialog.show();
                    // 获取附近的人列表(女)
                    getPeopleNearbyList(mUser.getUserId(), L0_Constant.USER_SEX_FEMALE);
                }
            });
            ...
            mMalesOnlyRl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mDialog.show();
                    // 获取附近的人列表(男)
                    getPeopleNearbyList(mUser.getUserId(), L0_Constant.USER_SEX_MALE);
                }
            });
    ...
    private void initView() {
        ...
        mPeopleNearbyLv.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (isFriend) {
                ...
                intent.putExtra("from", L0_Constant.CONTACTS_FROM_PEOPLE_NEARBY);
            }
...
//            int errorCode = location.getLocType();
            ...
            if (!mLocateFlag) {
                ...
                L0_SharedPreferences.getInstance().setPositionInfo(positionInfo);
    ...
    private void uploadPositionInfo(String userId, double longitude, double latitude, String district) {
        String url = L0_Constant.BASE_URL + "peopleNearby/positionInfo";
    ...
    private void getPeopleNearbyList(String userId, final String userSex) {
        ...
        if (TextUtils.isEmpty(userSex)) {
            url = L0_Constant.BASE_URL + "peopleNearby?userId=" + userId;
            sexFilter = false;
        } else {
            url = L0_Constant.BASE_URL + "peopleNearby?userId=" + userId + "&userSex=" + userSex;
            sexFilter = true;
        }
    ...
    private void deletePositionInfo(String userId) {
        String url = L0_Constant.BASE_URL + "peopleNearby/positionInfo?userId=" + userId;

        mVolleyUtil.httpDeleteRequest(url, response -> {
            mDialog.dismiss();
            L0_SharedPreferences.getInstance().setOpenPeopleNearby(false);
            finish();
        }, volleyError -> {
