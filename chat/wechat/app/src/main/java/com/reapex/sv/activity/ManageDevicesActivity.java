...
import com.reapex.sv.adapter.ManageDevicesAdapter;
import com.reapex.sv.L0_Constant;
import com.reapex.sv.daodb.DeviceInfoDao;
 ...
 * @author zhou
 */
public class ManageDevicesActivity extends L0_BaseActivity {
    ...
    private void getDeviceInfoListByUserId(String userId) {
        String url = L0_Constant.BASE_URL + "users/" + userId + "/devices";
    ...
    private void updateUserLoginDevice(final int position, String userId, final DeviceInfo deviceInfo, final String phoneModelAlias) {
        String url = L0_Constant.BASE_URL + "users/" + userId + "/devices/" + deviceInfo.getDeviceId();
