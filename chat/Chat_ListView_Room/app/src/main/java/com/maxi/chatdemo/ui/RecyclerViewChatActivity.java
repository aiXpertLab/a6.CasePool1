...
public class RecyclerViewChatActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        tbAdapter = new ChatRecyclerAdapter(this, chatMessageBeanList);
            ...
            if (theActivity != null) {
                switch (msg.what) {
                    ...
                    case SEND_OK:
                        ...
                        theActivity.tbAdapter.isPicRefresh = true;
                        theActivity.tbAdapter.notifyItemInserted(theActivity.chatMessageBeanList
                                .size() - 1);
    ...
    private void receriveVoiceText(final float seconds, final String filePath) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                tbAdapter.unReadPosition.add(chatMessageBeanList.size() + "");
